		...
		<form action="/jsptest/board/writePro.do" name="writeForm"
			...
			<table width="450" border="1" cellpadding="0" cellspacing="0"
				...
				<tr class="mb-3 mt-3">
					...
					<td width="330"><textarea class="form-control" name="content"
							rows="13" cols="50"></textarea></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2" align="center"><input
						type="submit" value="글쓰기" class="btn btn-primary"/> <input
						type="reset" value="다시작성" class="btn btn-primary" /> <input
						type="button" value="글목록"
						onclick="window.location='/jsptest/board/list.do'"
